...
class BusinessAccountSettings extends StatefulWidget {
  ...
  const BusinessAccountSettings(
      {super.key, required this.cubit, required this.isUpdate});
...
class _BusinessAccountSettingsState extends State<BusinessAccountSettings> {
  ...
  void initState() {
    ...
    widget.cubit.fetchAllLocations();
    _selectedCountry = widget.cubit.selectedCountry;
    _selectedState = widget.cubit.selectedState;
    _selectedCity = widget.cubit.selectedCity;
  }
  ...
  Widget _buildVideoUploadSection(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        SizedBox(height: 10.h),
        AppTextField(
          controller: widget.cubit.videoUrlController,
